...
const ProductReviews = React.memo(({ productId, productName }: ProductReviewsProps) => {
  ...
  if (isLoading) {
    return (
      <div className="mt-12">
        <Card>
          <CardContent className="py-12 text-center text-gray-500">Loading reviews...</CardContent>
        </Card>
      </div>
    );
  }
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            ...
            <div className="text-center md:text-left">
              ...
              {user ? (
                ...
                <p className="mt-4 text-sm text-gray-500">Sign in to write a review</p>
              )}
            </div>
