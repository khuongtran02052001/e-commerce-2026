  ...
  const getTimelineEvents = (): TimelineEvent[] => {
    ...
    if (isDelivered) {
      ...
      events.push({
        ...
        status: (isCOD ? isCashCollected : isDispatched) ? 'current' : 'pending',
        icon: <Package className="w-5 h-5" />,
      });
    }
          ...
          {events.map((event, index) => (
            <div
              ...
              className={cn(
                ...
                index < visibleItems ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-6',
              )}
              style={{
              ...
              <div className="flex items-start gap-4">
                ...
                <div
                  className={cn(
                    ...
                    event.status === 'pending' && 'bg-gray-100 text-gray-400 scale-95',
                ...
                <div className="flex-1 pt-0.5">
                      ...
                      {event.description && (
                        <p
                          className={cn(
                            ...
                            event.status === 'current' && 'text-gray-800 font-medium',
                  ...
                  {event.status === 'completed' && index === visibleItems - 1 && (
