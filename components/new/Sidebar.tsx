          ...
          <div className="flex flex-col gap-1">
            {categoriesData.slice(0, 6).map((item) => (
              <Link
                ...
                className="rounded-lg px-2 py-1.5 text-xs font-medium capitalize text-light-color transition-colors duration-200 hover:bg-shop_light_pink/60 hover:text-shop_dark_green"
              >
                {item.title}
              </Link>
            ))}
            <Link
              onClick={onClose}
              href="/category"
              className="mt-1 rounded-lg px-2 py-1.5 text-xs font-semibold text-shop_dark_green transition-colors duration-200 hover:bg-shop_light_pink/60 hover:text-shop_btn_dark_green"
            >
              View All Categories →
            </Link>
          </div>
