...
export default function AdminSubscriptions() {
  ...
  const fetchSubscriptions = async () => {
    ...
    try {
      const response = await fetchService('/admin/subscriptions');
      if (response.ok) {
  ...
  const handleCleanupDuplicates = async () => {
    ...
    try {
      const response = await fetchService('/admin/subscriptions/cleanup-duplicates', {
        method: 'POST',
      });
  ...
  const handleDeleteConfirm = async () => {
    ...
    setIsDeleting(true);
    try {
      const response = await fetchService(`/admin/subscriptions/${subscriptionToDelete.id}`, {
        method: 'DELETE',
      });
