        ...
        <Container className="max-w-6xl">
          ...
          >
            ...
            <p className="text-xl text-white/90 max-w-3xl mx-auto">
              ...
              and responsibilities as a ShopCart user.
            </p>
                      ...
                      <AccordionContent className="px-6 pb-6">
                        ...
                        <div className="space-y-4">
                          {section.content.map((paragraph, pIndex) => (
                            <p key={pIndex} className="text-dark-text leading-relaxed">
                              {paragraph}
                            </p>
                          ))}
                        </div>
            ...
            <Card className="text-center">
              <CardContent className="p-8">
                ...
                <p className="text-dark-text mb-6 max-w-2xl mx-auto">
                  ...
                  any section, our legal team is here to help.
                </p>
        ...
        <Container className="max-w-4xl">
          <div className="text-center">
            ...
            <p className="text-xs text-light-text">
              By continuing to use ShopCart, you agree to the most current version of these terms.
            </p>
          </div>
        </Container>
      </section>
