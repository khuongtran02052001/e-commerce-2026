...
import { ArrowLeft, CheckCircle2, CreditCard, Loader2, Lock, Wallet, XCircle } from 'lucide-react';
...
export default function PaymentPage() {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      const response = await fetchService('/checkout/complete', {
        method: 'POST',
        body: JSON.stringify({
          orderId,
          sessionId,
    ...
    <div className="min-h-screen bg-linear-to-br from-purple-50 via-white to-blue-50 py-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        >
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Clerk Payment</h1>
          <p className="text-gray-600">Secure payment powered by Clerk authentication</p>
        </motion.div>
          ...
          <Card className="mb-6">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex justify-between items-center pb-3 border-b">
                ...
                <span className="font-medium text-sm">{`user.[0]?.emailAddress`}</span>
              </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700">
                  Your payment is secured with Clerk authentication. Your personal information is
