...
const SuccessPage = () => {
  ...
  const query = defineQuery(`*[_type == 'order' && clerkUserId == $userId] | order(orderDate desc){
  ...,products[]{
    ...,product->
  }
}`);
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-gray-600 mb-6 max-w-2xl mx-auto">
            Thank you for your purchase! Your order has been confirmed and we&apos;re preparing it
            for shipment. You&apos;ll receive a confirmation email
          </p>
          ...
          {orderNumber && (
            <div className="bg-white rounded-lg p-6 shadow-md inline-block">
              <div className="flex items-center justify-center gap-3">
                ...
                <span className="text-xl font-bold text-green-600">{orderNumber}</span>
              </div>
            </div>
          )}
        </motion.div>
